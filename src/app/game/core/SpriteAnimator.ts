...
export class SpriteAnimator {
	...
	draw(
		...
		if (flipped) {
			...
			ctx.drawImage(this.image, sx, sy, this.frameWidth, this.frameHeight, 0, 0, width, height);
		} else {
			ctx.drawImage(this.image, sx, sy, this.frameWidth, this.frameHeight, x, y, width, height);
		}
